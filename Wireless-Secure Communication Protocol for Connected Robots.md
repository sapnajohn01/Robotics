...
•	Why challenge–response: Prevents replay and avoids sending raw passwords. As robotic systems bridge IoT stacks, even basic authentication must resist trivial interception and replay across heterogeneous networks
