...
Here's a modular Arduino-based architecture tailored for your disaster response robot prototype. It’s structured for flexibility, allowing sensor packages and behaviors to be swapped easily depending on mission needs
📁 1. motorControl.ino
